function [CenterPos,CenterInd,CenterIntenList,ClusterMap,ClusterLabelList]=CluterToUpdateCenter(ClusterMap,ImageList)
...
% ClusterLabelList = LabelList;
ClusterLabelList = [1:LabelNum]';
for i=1:LabelNum
    Label=LabelList(i);
